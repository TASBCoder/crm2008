...
<%
	...
	System.out.println("创建市场活动的所有者所用的数据Users = " + users);
	Object Activities = request.getAttribute("Activities");
	System.out.println("创建市场活动的页面展示用的数据Activity = " + Activities);
%>
<!DOCTYPE html>
<html>
<head>
	...
	$(function(){
		...
		$("#saveActivityBtn").click(function () {
			...
			*/
			...
			// 	$.ajax({
			// 		url: "workbench/activity/selectAllActivity",
			// 		type: "post",
			// 		success: function (data){
			// 			alert(data)
			// 		}
					...
					<tbody>
						<c:forEach items="${Activities}" var="activity">
							<tr class="active">
								...
								//所有者，此时tbl_activity表中存储的是所有者的id
