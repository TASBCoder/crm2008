		...
		function btnClick(){
			...
			$.ajax({
				...
				success: function (data){
					if(data.code == "1"){
						window.location.href = "workbench/goIndex"
					}else{
		...
		<div style="position: absolute; top: 0px; right: 60px;">
			...
			<form class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<button type="button" id="btn" onclick="btnClick()" class="btn btn-primary btn-lg btn-block"  style="width: 350px; position: relative;top: 45px;">登录</button>
				</div>
			</form>
		</div>
	</div>
